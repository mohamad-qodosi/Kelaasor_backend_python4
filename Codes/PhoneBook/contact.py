class Contact:
    def __init__(self, first_name: str, last_name: str, phone_number: str):
        ...
        # self.__name = {'__first_name': __first_name, '__last_name': __last_name}
        self.__phone_number = phone_number

    def set_first_name(self, first_name: str) -> None:
        self.__first_name = first_name
        # self.__name['__first_name'] = __first_name

    def get_first_name(self) -> str:
        return self.__first_name
        # return self.__name['__first_name']

    def get_last_name(self) -> str:
        return self.__last_name
        # return self.__name['__last_name']
...
if __name__ == '__main__':
    first_name = input("Enter first __name: ")
    last_name = input("Enter last __name: ")
